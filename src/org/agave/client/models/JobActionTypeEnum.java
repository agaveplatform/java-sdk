...
public enum JobActionTypeEnum {
    RESUBMIT, //TODO: Write general description for this element
    STOP; //TODO: Write general description for this element
    /**
    ...
    * @return	The enum member against the given integer value */
    ...
    public static JobActionTypeEnum fromString(String toConvert) {
        return JobActionTypeEnum.valueOf(toConvert);
    }
