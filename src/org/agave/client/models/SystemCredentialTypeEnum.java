...
public enum SystemCredentialTypeEnum {
    LOGIN, //TODO: Write general description for this element
    ...
    * @return	The enum member against the given integer value */
    ...
    public static SystemCredentialTypeEnum fromString(String toConvert) {
        return SystemCredentialTypeEnum.valueOf(toConvert);
    }
